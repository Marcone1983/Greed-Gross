...
class ApiClient {
    ...
    companion object {
        private const val GREED_GROSS_SYSTEM_PROMPT = "Esperto breeder, genetista, farmacista, erborista, agronomo. Sono GREED & GROSS, un esperto genetista della cannabis."
    }
